$(document).ready(function () {
    ...
    function fetchAttendanceData(filter) {
        ...
        // Make AJAX request
        $.ajax({
            url: '/admin/attendance', // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
                // Update the card with fetched data
    ...
    function fetchLeaveData(filter) {
        ...
        $.ajax({
            url: '/admin/leave', // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
    ...
    function fetchEarlyLeftData(filter) {
        ...
        // Make AJAX request to fetch leave data
        $.ajax({
            url: '/admin/early-left', // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
                // Update leave count in the UI
    ...
    function fetchOvertimeData(filter) {
        ...
        // Make AJAX request to fetch leave data
        $.ajax({
            url: '/admin/on-time', // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
                // Update leave count in the UI
    ...
    function fetchAdminDashboardData() {
        ...
        $.ajax({
            url: '/admin/dashboard/data',  // This should be the route for your `getAllAttendanceData` method
            method: 'GET',
            success: function (response) {
                if (response.success) {
