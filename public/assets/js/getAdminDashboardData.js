$(document).ready(function () {
    ...
    function fetchAttendanceData(filter) {
        ...
        // Make AJAX request
        $.ajax({
            url: getAdminAttendanceCount, // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
                // Update the card with fetched data
    ...
    function fetchLeaveData(filter) {
        ...
        $.ajax({
            url: getAdminTotalLeaves, // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
    ...
    function fetchLateArrivalData(filter) {
        ...
        // Make AJAX request to fetch leave data
        $.ajax({
            url: getAdminLateArrivals, // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
                // Update leave count in the UI
    ...
    function fetchEarlyLeftData(filter) {
        ...
        // Make AJAX request to fetch leave data
        $.ajax({
            url: getAdminEarlyDepartures, // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
                // Update leave count in the UI
    ...
    function fetchOvertimeData(filter) {
        ...
        // Make AJAX request to fetch leave data
        $.ajax({
            url: getAdminOntime, // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
                // Update leave count in the UI
    ...
    function fetchAdminDashboardData() {
        ...
        $.ajax({
            url: getAdminDashboardData,  // This should be the route for your `getAllAttendanceData` method
            method: 'GET',
            success: function (response) {
                if (response.success) {
