$(document).ready(function () {
    ...
    function fetchWorkingHours(filter) {
        ...
        // Make AJAX request
        $.ajax({
            url: '/attendance/hours', // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
    ...
    function fetchAttendanceData(filter) {
        ...
        // Make AJAX request
        $.ajax({
            url: '/attendance/count', // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
                // Update the card with fetched data
    ...
    function fetchLeaveData(filter) {
        ...
        $.ajax({
            url: '/attendance/leave', // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
    ...
    function fetchLateArrivalData(filter) {
        ...
        // Make AJAX request to fetch leave data
        $.ajax({
            url: '/attendance/late-arrival', // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
                // Update leave count in the UI
    ...
    function fetchEarlyLeftData(filter) {
        ...
        // Make AJAX request to fetch leave data
        $.ajax({
            url: '/attendance/early-left', // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
                // Update leave count in the UI
    ...
    function fetchOvertimeData(filter) {
        ...
        // Make AJAX request to fetch leave data
        $.ajax({
            url: '/attendance/overtime', // Update this to your backend route
            method: 'GET',
            data: { filter: filter },
            success: function (response) {
                // Update leave count in the UI
    ...
    function fetchAllAttendanceData() {
        ...
        $.ajax({
            url: '/dashboard/data',  // This should be the route for your `getAllAttendanceData` method
            method: 'GET',
            success: function (response) {
                if (response.success) {
