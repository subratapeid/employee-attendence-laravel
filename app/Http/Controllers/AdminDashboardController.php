...
{
    public function getTotalAbsent(Request $request)
    {
        ...
        return response()->json([
            ...
            'total_absent' => $totalWorkingMinutes,
            'date_range' => [
    ...
    public function getOntime(Request $request)
    {
        $filter = $request->get('filter', 'this_week');
    ...
    public function getAdminDashboardData(Request $request)
    {
        ...
        $totalWorkingHours = $this->getTotalAbsent($request)->original['total_absent'];
        ...
        $overtime = $this->getOntime($request)->original['total_ontime'];
